...
export default function CoursePage() {
  ...
  useEffect(() => {
    const filePath = `../../content/courses/${slug}.md`
    const loader = courseFiles[filePath]
    if (!loader) return
    loader().then((raw) => {
  ...
  return (
    <div className="flex flex-col px-4 py-6">
      <div className="mb-4">
        <Link
          to="/"
          className="inline-flex items-center text-gray-400 hover:text-lime-300 transition"
        >
          <svg
            className="w-5 h-5"
            fill="none"
